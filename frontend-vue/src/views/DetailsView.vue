...
const paramExplains: Record<string, string> = {
  ...
  'lr0': '初始学习率',
  'lrf': '最终学习率倍数',
  'momentum': 'SGD中的动量因子/AdamW中的的一阶矩衰减系数',
  'weight_decay': '权重衰减，用于正则化',
  'warmup_epochs': '预热轮数',
  'warmup_momentum': '预热初始动量',
  'warmup_bias_lr': '预热阶段偏置项的学习率',
  'cos_lr': '是否开启余弦学习率调度',
  'close_mosaic': '训练最后 N 轮关闭 Mosaic 增强，稳定收敛',
  'hsv_h': 'HSV-Hue 增强',
  ...
  'mixup': 'Mixup 增强概率',
  'copy_paste': '拷贝粘贴增强概率',
  'gaussian_noise': '高斯噪声增强概率（EasyYolo 自定义增强）',
  'gaussian_blur': '高斯模糊增强概率（EasyYolo 自定义增强）',
  'seed': '随机种子',
