...
export function collectTrainingParams() {
    return {
        ...
        warmup_bias_lr: document.getElementById('p_warmup_bias_lr').value,
        cos_lr: document.getElementById('p_cos_lr').checked,
        close_mosaic: document.getElementById('p_close_mosaic').value,
        ...
        gaussian_noise: document.getElementById('p_gaussian_noise').value,
        gaussian_blur: document.getElementById('p_gaussian_blur').value,
